...
싼타페를 알아보는 분들이 가장 많이 묻는 질문은 하나로 정리됩니다. **"1,000만 원 이상 싼 4세대 TM 중고를 살까, 아니면 신형 MX5를 새로 뽑을까?"** 그리고 그 안에서 다시 **"2.5 가솔린 터보냐, 1.6 터보 하이브리드냐"** 로 갈립니다. 이 글은 카탈로그 숫자가 아니라, 두 세대의 정비 지침서와 공개된 정비 이력 데이터를 대조해 비교합니다.
