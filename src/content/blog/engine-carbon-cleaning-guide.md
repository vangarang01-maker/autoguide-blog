...
heroEmoji: '🧼'
heroImage: '/images/heroes/engine-carbon-cleaning-guide.svg'
---

"연비가 예전 같지 않고, 아침 시동 때 부르릉 떨려요. 그런데 정비소에서는 이상 없다고 합니다." **주행거리 6만~10만 km 사이 GDI 차량**에서 가장 많이 나오는 상담입니다. 대부분 흡기 밸브 카본 누적입니다. 왜 GDI만 이 문제를 겪는지부터 짚어야 대처법이 보입니다.
...
관리만 하면 GDI는 여전히 연비와 출력 모두에서 우수한 엔진입니다. 특히 [싼타페 2.5 T-GDi 같은 터보 GDI 차량](/blog/santafe-tm-vs-mx5-comparison/)을 고민 중이라면, 이 유지비 항목을 처음부터 예산에 넣고 시작하세요.
